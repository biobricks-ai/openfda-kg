...
class URIBuilders:
    ...
    def build_company_uri(self, company_name: str) -> URIRef:
        """Build URI for drug company/sponsor using SIO organization."""
        clean_name = company_name.replace(" ", "_").replace(",", "").replace(".", "")
        return URIRef(self._namespaces["company"] + quote(clean_name, safe=""))
    
    def build_sponsor_uri(self, sponsor_name: str) -> URIRef:
        """Build URI for application sponsor (alias for company)."""
        return self.build_company_uri(sponsor_name)
    
    def build_manufacturer_uri(self, manufacturer_name: str) -> URIRef:
        """Build URI for drug manufacturer (alias for company)."""
        return self.build_company_uri(manufacturer_name)
    ...
    # =============================================================================
    # PRODUCT IDENTIFIERS - NDC, RxCUI, SPL codes
    # =============================================================================
